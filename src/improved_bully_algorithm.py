...
class Node:
    def __init__(self, node_id, nodes):
        ...
        self.knows_higher_active = False  # New attribute to track if a higher node is active
    ...
    def start_election(self):
        ...
        self.knows_higher_active = False  # Reset knowledge of higher active nodes
        ...
        if not higher_nodes:
            ...
            # Send Election message to all higher nodes only if we do not know about any higher active nodes
            if not self.knows_higher_active:
